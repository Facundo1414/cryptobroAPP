-- Migration SQL for Crypto Analyzer Database
-- Execute this script in your Supabase SQL Editor
-- 
-- IMPORTANT: This uses Supabase Authentication (auth.users)
-- The users table in public schema stores additional user data
-- and references auth.users via UUID
...
-- Convert Candle to hypertable for efficient time-series queries
